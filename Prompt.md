Prompt 
Context and Role 
So basically I am a developer who knows Python well and I want to build my own business 
website. For backend I will use FastAPI and for frontend simple HTML, CSS, JavaScript — no 
React or anything. The site should look clean and professional like a proper startup website, 
load fast, and everything should work properly on mobile also. 
Objective 
...
Page Sections 
My website will have these sections — all on one page or separate pages, whatever looks 
better:    
Hero Section — big heading, one line about my business, a button like "Get Started" or "Book a 
Demo" 
...
If email fails for some reason — log it, don't crash, try again if possible, still show success to 
user 
Data Storage Requirements 
Save all contact form submissions in a database — PostgreSQL for production, SQLite for 
testing locally 
...
When server starts, check all required variables are present — if something missing, show clear 
error and stop 
