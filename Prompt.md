...
- FastAPI backend with proper REST APIs
- Contact form that saves data in DB and sends me email
- SEO-friendly so it comes good on Google search
- Everything runs on Docker so I can deploy it on any server
